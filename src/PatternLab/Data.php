...
class Data {
	...
	protected static $reservedKeys = array("listItems","cacheBuster","patternLabLink","patternSpecific","patternLabHead","patternLabFoot");
	 ...
	 *    - Data::$store["patternLabLink"] : the links to each pattern
	...
	public static function gather($options = array()) {
		...
		self::$store["patternLabLink"]            = array();
	...
	public static function setOptionLink($optionName,$optionValue) {
		...
		if (!isset(self::$store["patternLabLink"])) {
			self::$store["patternLabLink"] = array();
		}

		self::$store["patternLabLink"][$optionName] = $optionValue;
